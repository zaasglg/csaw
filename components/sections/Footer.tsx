        ...
        <div className="grid gap-12 pb-14 md:grid-cols-[1fr_auto_auto]">
          ...
          <div>
            ...
            <a
              ...
              className="mt-5 flex items-center gap-2 text-sm text-primary-600 transition-colors hover:text-accent"
            >
            ...
            <a
              ...
              className="mt-3 block text-sm text-primary-600 transition-colors hover:text-accent"
            >
